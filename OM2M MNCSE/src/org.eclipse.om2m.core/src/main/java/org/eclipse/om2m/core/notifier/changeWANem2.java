...
//		int x=	5	; 
		if(args.length>0) {
			loss=Integer.parseInt(args[0]);
		}
		if(args.length>1) {
			bandwidth=Integer.parseInt(args[1]);
		}
...
//				delay=10;
//		}
		change(loss,bandwidth);
		System.out.println("change finished");
		System.out.println("loss:"+loss+"%");
		System.out.println("bandwidth:"+bandwidth+"Kbps");
...
//		System.out.println("delay:"+delay);
	...
	public static int change(Integer iPacketLossRate,Integer bandwidth) {
