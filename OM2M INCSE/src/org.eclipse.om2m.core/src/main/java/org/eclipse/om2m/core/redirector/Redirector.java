...
//		System.out.println(line);
	...
	public static void marktime(RequestIndication requestIndication) {
		String[] tmp0=requestIndication.getRepresentation().split("<str name='coredelay' val='");
		String google_time=getgoogletime();
		String newcontent=tmp0[0]+"<str name='coredelay' val='"+google_time+"'/><str name='efficiency' val='"+ 0.0 +"'/></obj>";
